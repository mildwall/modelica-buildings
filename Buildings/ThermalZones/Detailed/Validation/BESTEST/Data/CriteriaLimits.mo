...
record CriteriaLimits
  ...
  parameter Modelica.SIunits.Energy lowerLimit "Lower limit of the test acceptance criteria";
  parameter Modelica.SIunits.Energy upperLimit "Upper limit of the test acceptance criteria";
 annotation (
   Documentation(info=
"<html>
<p>
